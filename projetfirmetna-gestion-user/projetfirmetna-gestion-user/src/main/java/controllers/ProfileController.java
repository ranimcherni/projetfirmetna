...
public class ProfileController {
    ...
    private void handleProduits(ActionEvent event) {
        ProductNavigationState.setSelectedType("tous");
    ...
    private void handleProduitsVegetaux(ActionEvent event) {
        ProductNavigationState.setSelectedType("vegetale");
        NavigationService.switchScene(event, "/esprit/tn/fxml/product_marketplace.fxml", "Produits vegetaux");
    }

    @FXML
    private void handleProduitsAnimaux(ActionEvent event) {
        ProductNavigationState.setSelectedType("animale");
        NavigationService.switchScene(event, "/esprit/tn/fxml/product_marketplace.fxml", "Produits animaux");
    }
