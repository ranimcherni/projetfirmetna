...
public class HomeController {
    ...
    @FXML
    public void handleGoToFrontPartner(javafx.scene.input.MouseEvent event) {
        System.out.println("DEBUG: Partner icon clicked!");
        utils.NavigationService.switchScene(event, "/esprit/tn/fxml/FrontPartnerView.fxml", "Espace Partenaire");
    }
}
