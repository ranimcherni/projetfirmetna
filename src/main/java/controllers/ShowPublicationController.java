...
public class ShowPublicationController {
    ...
    public void initData(Publication p) {
        ...
        lblDate.setText("PubliÃ¢â€Å“Ã‚Â® le: " + p.getDateCreation());
    ...
    private void savePublicationUpdate(ActionEvent event) {
        ...
        if (newTitre.isEmpty() || newContenu.isEmpty()) {
            ...
            alert.setContentText("Le titre et le contenu ne peuvent pas Ã¢â€Å“Ã‚Â¬tre vides.");
            alert.show();
            return;
        }
    ...
    private void postComment(ActionEvent event) {
        ...
        if (texte.isEmpty()) {
            ...
            alert.setContentText("Veuillez Ã¢â€Å“Ã‚Â®crire un commentaire.");
            alert.show();
            return;
        }
        ...
        if (selectedCommentForEdit != null) {
            ...
            c.setAuteurId(utils.UserSession.getInstance().getUser().getId());
            sc.add(c);
        }
    ...
    private void editCommentAction(ActionEvent event) {
        ...
        if (selectedCommentForEdit == null) {
            Alert alert = new Alert(Alert.AlertType.WARNING);
            alert.setContentText("Veuillez sÃ¢â€Å“Ã‚Â®lectionner un commentaire Ã¢â€Å“ÃƒÂ¡ modifier.");
            alert.show();
            return;
        }

        txtNewComment.setText(selectedCommentForEdit.getContenu());
        btnPostComment.setText("Mettre Ã¢â€Å“ÃƒÂ¡ jour");
